Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Mike Silvis"
  # s.authors            = { "Mike Silvis" => "mikesilvis@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Mike Silvis"
  ...
  s.source       = { :git => "http://EXAMPLE/GAMConstants.git", :tag => "#{s.version}" }
